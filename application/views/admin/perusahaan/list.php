                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($perusahaan as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="<?= site_url('admin/user/list/' . $data->id_perusahaan) ?>" class="btn btn-success">
                                                                <i class="fas fa-users"></i><br>
                                                                Users
                                                            </a>
                                                            <button type="button" class="btn btn-info" title="Edit" onclick="edit_perusahaan('<?php echo $data->id_perusahaan ?>')">
                                                                <i class="fas fa-edit"></i><br>
                                                                Edit
                                                            </button>
                                                            <button type="button" class="btn btn-danger" onclick="confirmDelete('<?= site_url('admin/perusahaan/delete/' . $data->id_perusahaan) ?>','<?= $data->nama_perusahaan ?>')">
