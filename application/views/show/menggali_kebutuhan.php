                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="<?= site_url('form/menggali_kebutuhan/pdf/' . $id_isi) ?>" class="btn btn-warning float-right"><i class="fas fa-file-download"></i></a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-head-fixed">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>SITUATION (SITUASI)</td>
                                                <td><?= $pertanyaan1 ?></td>
                                                <td><?= $pertanyaan5 ?></td>
                                                <td><?= $pertanyaan9 ?></td>
                                            </tr>
                                            <tr>
                                                <td>PROBLEM (MASALAH & TANTANGAN)</td>
                                                <td><?= $pertanyaan2 ?></td>
                                                <td><?= $pertanyaan6 ?></td>
                                                <td><?= $pertanyaan10 ?></td>
                                            </tr>
                                            <tr>
                                                <td>IMPLICATION (KESAKITAN BILA TIDAK BERUBAH)</td>
                                                <td><?= $pertanyaan3 ?></td>
                                                <td><?= $pertanyaan7 ?></td>
                                                <td><?= $pertanyaan11 ?></td>
                                            </tr>
                                            <tr>
                                                <td>NEED PAYOFF (KENIKMATAN BILA TIDAK BERUBAH)</td>
                                                <td><?= $pertanyaan4 ?></td>
                                                <td><?= $pertanyaan8 ?></td>
                                                <td><?= $pertanyaan12 ?></td>
                                            </tr>
